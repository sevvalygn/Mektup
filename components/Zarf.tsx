...
=======
      className="block max-w-[90%] max-h-[90vh] w-auto h-auto object-contain cursor-pointer shadow-[0_12px_40px_rgba(0,0,0,0.5)] hover:opacity-95 transition-opacity focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 focus:ring-offset-white"
>>>>>>> Stashed changes
